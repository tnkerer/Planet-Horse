...
const Team: React.FC<Props> = ({ scrollValueToAnimate }) => {
  ...
  return (
    <div className={styles.container}>
      ...
      >
        <TeamCard imageFront={t} imageBack={tFace} avatarName='T' realName='natã' position='marketing' to='https://www.linkedin.com/in/natã-teixeira-916596228/' />
        <TeamCard imageFront={bizzo} imageBack={bizzoFace} avatarName='deividy' realName='deividy' position='marketing' to='https://twitter.com/deividy1864' />
        ...
        <TeamCard imageFront={ko} imageBack={koFace} avatarName='koroshy' realName='koroshy' position='artist' to='https://www.behance.net/Koroshy' />
        ...
        <TeamCard imageFront={ano} imageBack={anoFace} avatarName='juliano' realName='juliano' position='advisor' to='https://www.linkedin.com/in/juliano-senfft' />
