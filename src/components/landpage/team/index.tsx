...
import phillipe from '@/assets/landing-page/team/faces/phillipe.jpg'
    ...
    <div className={styles.container} ref={myRef}>
      ...
      <div className={styles.container_team}>
        ...
        `}>
          ...
          <div className={styles.cards_card}>
            <TeamCard imageFront={bizzo} imageBack={phillipe} avatarName='phillipe' realName='phillipe' position='marketing' index={1} to='https://github.com/menezesphill' />
          </div>
          <div className={styles.cards_card}>
